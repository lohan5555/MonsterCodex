Ce projet est un jeu mobile développé avec le moteur de jeu Unity, dans le cadre d'un cours de 1ère année de master d'informatique par Lohan Hébert et Lenny Loy. 
